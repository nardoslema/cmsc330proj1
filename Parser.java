...
class Parser {
    ...
    int[]  getNumberList(int count) throws LexicalError, SyntaxError, IOException {
    ...
    int[] getNumberList() throws LexicalError, SyntaxError, IOException {
    ...
    void verifyNextToken(Token expectedToken) throws LexicalError, SyntaxError, IOException {
        token = lexer.getNextToken();
    ...
    void verifyCurrentToken(Token expectedToken) throws SyntaxError {
